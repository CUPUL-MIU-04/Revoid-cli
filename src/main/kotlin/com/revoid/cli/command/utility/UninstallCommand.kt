package com.revoid.cli.command.utility

import com.revoid.library.installation.installer.AdbInstaller
import com.revoid.library.installation.installer.AdbInstallerResult
import com.revoid.library.installation.installer.AdbRootInstaller
import com.revoid.library.installation.installer.RootInstallerResult
...
internal object UninstallCommand : Runnable {
    ...
    @Parameters(
        description = ["Serial of ADB devices. If no se suministra, se usará el primer dispositivo conectado."],
        arity = "0..*",
    )
